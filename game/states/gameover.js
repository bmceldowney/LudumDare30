...
GameOver.prototype = {
  ...
  create: function () {
    distance.getDistance(this.game.time.now, speed.speedFactor);
    ...
    this.distanceText = this.game.add.bitmapText(this.game.world.centerX, 425, 'pixelation', 'Distance: ' + (distance.distance) + ' meters', 32);
